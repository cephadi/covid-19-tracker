...
Label(root, text="Enter all countries, for whom you want to get!", font="Consolas 15").pack()
...
entry = Entry(root, textvariable=data, width=60).pack()

Button(root, text="Show Data", command=displayData).pack()
